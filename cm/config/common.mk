...
PRODUCT_PROPERTY_OVERRIDES += \
  ro.cm.version=Prime_DEV_$(shell date -u +%Y%m%d) \
  ro.cm.releasetype=REUP_EVITA \
  ro.modversion=Prime_DEV_$(shell date -u +%Y%m%d) \
  ro.cmlegal.url=http://shoredroid.forumotion.com

-include vendor/cm-priv/keys/keys.mk

CM_DISPLAY_VERSION := Prime_DEV_$(shell date -u +%Y%m%d)
...
PRODUCT_PROPERTY_OVERRIDES += \
  ro.cm.display.version=Prime_DEV_$(shell date -u +%Y%m%d)
